...
[source, json]
{
  "_links": {
    "sw360:components": {
      "href": "http://localhost:8091/api/components"
    },
    "sw360:projects": {
      "href": "http://localhost:8091/api/projects"
    },
    "sw360:users": {
      "href": "http://localhost:8091/api/users"
    },
    "curies": [
      {
        "href": "http://localhost:8091/docs/html5/{rel}.html",
        "name": "sw360",
        "templated": true
      }
    ]
...
[source, json]
{
  ...
  "projectType": "PRODUCT",
  "name": "MyIAM",
  "description": "The IAM is a multi tenant identity management service",
  "_links": {
     "self": {
        "href": "http://localhost:8091/api/projects/f501de82a6e87a4faf9451b13100216e"
      }
  }
}
...
The documentation is in a very early stage and is updated automatically with each Travis-CI build.
