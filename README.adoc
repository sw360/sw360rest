...
* ./gradlew build prepare docker
* docker-compose build
* docker-compose up
* Check/Modify the IP address in the DemoApplication and run it
* Browse to <docker-host>:9091/api/browser/index.html#/api
* Copy the same token you used in the previous section into the "Custom Request Headers"

In the future a sandbox token will be created automatically.
